...
def parse_args():
    ...
    parser.add_argument('--config', 
                        default='/home/ivms/local_disk/mmgeneration_add/configs/styleganv2/stylegan2_c2_256_b4x8_800k.py',
                        help='evaluation config file path')
    parser.add_argument('--checkpoint',
                        default='/home/ivms/net_disk_project/19045845/weights/stylegan2_c2_ffhq_256_b4x8_20210407_160709-7890ae1f.pth',
                        help='checkpoint file')
    parser.add_argument(
        '--files',
        metavar='FILES',
        nargs='+',
        default=['/home/ivms/local_disk/mmgeneration_add/apps/results/zjd.png',
                 '/home/ivms/local_disk/mmgeneration_add/apps/results/xjy.png'],
        help='path to image files to be projected')
    parser.add_argument(
        '--results-path', type=str,default='results/', help='path to store projection results.')
    parser.add_argument(
        '--use-cpu',
        action='store_true',
