_base_ = [
    '../_base_/datasets/unconditional_imgs_flip_1024x1024.py',
...
data = dict(
    ...
    val=dict(imgs_root='./data/strawberry')
)
...
metrics = dict(
    fid50k=dict(
        type='FID',  # inceo
        num_images=50000,  # 可调
        # inception_pkl='work_dirs/inception_pkl/ffhq-256-50k-rgb.pkl', # 可生成，一般生成全数据集
        inception_pkl=None,
        bgr2rgb=True),
