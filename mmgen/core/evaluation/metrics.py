...
TERO_INCEPTION_URL = r'E:\comprehensive_library\mmgeneration_add\weights\inception-2015-12-05.pt'  # noqa
...
def _load_inception_torch(inception_args, metric):
    ...
    if metric == 'FID':
        ...
        inception_model.load_state_dict(torch.load(r"E:\comprehensive_library\mmgeneration_add\weights\inception_v3_google-1a9a5a14.pth"))
        mmcv.print_log(
...
class FID(Metric):
    ...
    def _calc_fid(sample_mean, sample_cov, real_mean, real_cov, eps=1e-6):
        ...
        https://github.com/rosinality/styleganv2-pytorch/blob/master/fid.py#L34
        """
...
class PR(Metric):
    r"""Improved Precision and recall metric.
        ...
        Ref: https://github.com/NVlabs/styleganv2-ada-pytorch/blob/main/metrics/precision_recall.py  # noqa
        ...
        Tero's vgg16: https://nvlabs-fi-cdn.nvidia.com/styleganv2-ada-pytorch/pretrained/metrics/vgg16.pt
    ...
    def __init__(self,
        ...
        if os.path.isfile(vgg16_script):
            ...
            self.vgg16.load_state_dict(torch.load('/home/ivms/net_disk_project/19045845/weights/vgg16-397923af.pth'))
...
class IS(Metric):
    ...
    Tero's Inception V3: https://nvlabs-fi-cdn.nvidia.com/styleganv2-ada-pytorch/pretrained/metrics/inception-2015-12-05.pt  # noqa
...
class PPL(Metric):
    r"""Perceptual path length.
        ...
        Ref: https://github.com/rosinality/styleganv2-pytorch/blob/master/ppl.py # noqa
