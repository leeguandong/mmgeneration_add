...
class PerceptualLoss(torch.nn.Module):
    r"""LPIPS metric with VGG using our perceptually-learned weights.
        ...
        Ref: https://github.com/rosinality/styleganv2-pytorch/blob/master/lpips/__init__.py # noqa
    """
    ...
    def init_net(self,
        ...
        if pretrained:
            ...
            #     strict=False)
            self.net.load_state_dict(torch.load('/home/ivms/net_disk_project/19045845/weights/vgg.pth', map_location='cpu'), strict=False)
