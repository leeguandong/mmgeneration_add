...
class vgg16(torch.nn.Module):
    ...
    def __init__(self, requires_grad=False, pretrained=True):
        super().__init__()
        vgg_pretrained_features = tv.vgg16(pretrained=pretrained)
        vgg_pretrained_features.load_state_dict(torch.load('/home/ivms/net_disk_project/19045845/weights/vgg16-397923af.pth'))
