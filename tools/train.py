...
from mmgen_add.utils import collect_env
...
def parse_args():
    ...
    parser.add_argument('--config',
                        default=r'E:\comprehensive_library\mmgeneration_add\configs\layoutgan\layoutganpp.py',
                        help='train config file path')
    # parser.add_argument('--config',
    #                     default=r'E:\comprehensive_library\mmgeneration_add\configs\styleganv2\stylegan2_c2_ada_256_b4x8_30k.py',
    #                     help='train config file path')
